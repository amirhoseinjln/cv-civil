...
import { PhoneCall, Globe, Menu, X, Phone, MapPin, Mail } from 'lucide-react';
...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const navLinks = [
    { href: '#profile', labelFa: 'خلاصه سوابق', labelEn: 'Profile' },
    { href: '#experience', labelFa: 'سوابق خدمت و مسئولیت‌ها', labelEn: 'Experience' },
    { href: '#certificates', labelFa: 'مدارک و مهارت‌ها', labelEn: 'Credentials' },
    { href: '#projects', labelFa: 'آرشیو پروژه‌ها', labelEn: 'Projects' },
    { href: '#brands', labelFa: 'طراحی‌های فیوچر ویو', labelEn: 'FUTURE VIEW' },
  ];
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ['contact', 'brands', 'projects', 'certificates', 'experience', 'profile'];
  ...
  return (
    <>
      ...
      <div className="bg-[#090C10]/95 backdrop-blur-md border-b border-[#1C2230] text-[#8C95A8] text-[11px] py-1.5 px-4 hidden sm:block relative z-40">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1.5 text-[#EA845A]">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
              <span>کارشناس ارشد پروژه‌های عمرانی، درمانی و بیمارستانی · آماده همکاری و مشاوره</span>
            </span>
      ...
      <header className={`sticky top-0 z-40 w-full transition-all duration-300 ${
        isScrolled 
          ? 'bg-[#0E1117]/92 backdrop-blur-xl shadow-2xl border-b border-[#2C374D]/80 shadow-[0_10px_30px_rgba(0,0,0,0.5)]' 
          : 'bg-[#0E1117]/80 backdrop-blur-lg border-b border-[#222B3D]/70'
      }`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-20 flex items-center justify-between">
            ...
            <a 
              ...
              aria-label="محمدرضا ناصری - مهندس عمران"
            >
              <FutureViewLogo variant="icon" size="sm" theme="bronze" />

              <div className="flex flex-col text-right">
                {/* Bold Mohammad Reza Naseri Name */}
                ...
                <span className="text-[11px] font-medium text-[#9AA3B5] tracking-tight">
                  مدیریت پروژه‌های درمانی · بنیان‌گذار FUTURE VIEW
                </span>
              </div>
            </a>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <a
                href={`tel:${PERSONAL_INFO.phone}`}
                className="hidden sm:inline-flex items-center gap-2 px-3.5 py-2 text-xs font-bold text-[#FFFFFF] bg-[#DE7247] hover:bg-[#EA845A] rounded-lg transition-all shadow-md shadow-[#DE7247]/20 hover:shadow-[#DE7247]/35 cursor-pointer whitespace-nowrap"
              >
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden glass-panel border-b border-[#242C3D] px-4 pt-4 pb-6 space-y-4 animate-in slide-in-from-top-2 duration-200">
            {/* Header Info */}
            <div className="p-3 rounded-lg glass-sub-panel flex items-center justify-between">
              ...
              <span className="text-[10px] text-emerald-400 bg-emerald-950/60 border border-emerald-800/40 px-2 py-0.5 rounded font-bold">
                پاسخگو
              </span>
            </div>
            ...
            <div className="flex flex-col space-y-1">
              {navLinks.map((link) => (
                <a
                  ...
                  href={link.href}
                  onClick={(e) => handleNavClick(e, link.href)}
                  className="px-3.5 py-2.5 text-sm font-bold text-[#DCE2ED] hover:text-[#EA845A] hover:bg-[#181E2A]/70 rounded-lg transition-colors flex items-center justify-between"
                >
            ...
            <div className="pt-2 border-t border-[#202736] space-y-2">
              <a
                href={`tel:${PERSONAL_INFO.phone}`}
                className="w-full flex items-center justify-center gap-2 py-2.5 text-xs font-bold text-[#FFFFFF] bg-[#DE7247] rounded-lg shadow-md"
              >
