...
export const ProfileSummarySection: React.FC<ProfileSummaryProps> = ({ lang }) => {
  ...
  return (
    <section id="profile" className="py-12 sm:py-20 lg:py-24 bg-[#0E1117]/60 backdrop-blur-[2px] border-b border-[#1E2533] relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Editorial Narrative */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start mb-10 sm:mb-16">
          ...
          <div className="lg:col-span-6 space-y-3 sm:space-y-4">
            ...
            <h2 className="editorial-h2">
              {lang === 'fa' 
                ? '۱۶ سال فعالیت اجرایی و نظارتی در پروژه‌های زیربنایی کشور' 
                : '16 Years of Engineering Service in Critical Infrastructure'}
            </h2>
          ...
          <div className="lg:col-span-6 rounded-xl glass-panel p-5 sm:p-7 space-y-4">
            <div className="text-xs font-bold text-[#E5DFD4] pb-3 border-b border-[#242E40]">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-2.5">
                ...
                <p className="text-xs text-[#B2B9C8] leading-relaxed text-justify">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
          {pillars.map((pillar, idx) => (
            <div
              key={idx}
              className="p-5 rounded-xl glass-panel-interactive space-y-2 flex flex-col justify-between"
            >
              <div className="space-y-2">
                ...
                <p className="text-xs text-[#8C95A8] leading-relaxed text-justify">
                  {pillar.descFa}
                </p>
              </div>
            </div>
